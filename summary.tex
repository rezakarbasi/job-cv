...
\section{Summary}
  ...
  \item{Experienced AI and Robotics professional with a master's degree in Artificial Intelligence and Robotics from the University of Tehran. Skilled in Python, C/C++, and frameworks like PyTorch and TensorFlow. Proficient in signal processing and machine learning with a strong academic background. Demonstrated ability in algorithm development and software engineering roles. Research interests include Voice Command communication, Human-Robot interaction, and Signal Processing.}
